    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex justify-end pt-2">
           <a href="#" className="text-sm font-medium text-zinc-400 hover:text-[#1d348a] transition-colors">Forgot password?</a>
        </div>
        <Button type="submit" className="w-full bg-[#1d348a] hover:bg-[#1d348a]/90 text-white font-bold uppercase tracking-wide py-7 text-lg rounded-none transition-colors border-2 border-[#1d348a]" disabled={isLoading}>
